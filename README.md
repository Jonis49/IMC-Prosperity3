...
**Team:**
- [Jonatan Svensson](https://www.linkedin.com/in/jonatan-svensson-b81019365/)
- [Jack Sherry](https://www.linkedin.com/in/jack-sherry-739652299/)
- Adam Leddy  
- Conor Duddy  
...
In Round 4 macarons were introduced, a product which could be traded across two different exchanges. There was a bid ask spread with sizes specified on the local island, and prices specified on the other island, as well as import, export and transportation fees. Therefore, in order to trade macarons on the other island you had to pay either an import or export fee (depending on whether you were buying or selling) and a transportation fee. It is also worth noting that the local market spread was quite wide (~ 6 seashells wide), whereas the spread on the other island was much tighter (1.5 seashells). 

The export fees on each day were very large, typically around 8 seashells, meaning it was never possible to profitably buy macarons locally and sell them on the other island. The import fees however were negative, meaning you would get paid to import macarons. When the import fee was negative enough it became profitable to buy macarons on the other island and sell them locally. There was a catch to this though, as you could only import macarons if you were already short, and couldn’t pick up a long position by importing them. Therefore you were forced to sell the macarons locally first, before importing them. 

Before going short the macarons we needed to first decide whether it would be profitable to import them, and we determined this by defining a quantity which we called ‘shipping’. This value represented the net cost to import macarons, factoring in the import costs and the transportation costs and we computed it using the formula: Shipping = - Transportation Costs - Import Tariff. We considered including the spread on the other island in this quantity, but decided there was no need as the spread was a constant width the entire time. 
...
When looking initially at the performance of this strategy we found that it fared quite poorly due to the spreads being crossed locally to put on the trade. It was clear that market taking was hugely inefficient and we should be going short by market making. We therefore tested our fill rates at different edge requirements on the submission to get a feel for what the flow looked like when market making. 

We found that it was very difficult (if not impossible) to get filled when quoting for edge (relative to mid), and in order to get any fills while making we would have to sacrifice edge. This meant that performed market making on the macarons locally offered little to no edge, and trading in the local market could only be profitably utilised when paired with trades on the other island. 

When testing different fill rates we realised that it was possible to get filled reasonably often by giving up 1 seashell of edge. This seemed great on the surface, but a much greater opportunity lay beyond this. When testing our fill rates, when giving up 2 seashells of edge we found that we were getting filled over twice as much. There was one local market participant who would only market take and would only trade when given 2+ seashells of edge, and they traded in big size. This meant that when ‘shipping’ was high (when we were getting paid a lot to import : 3+ seashells of edge) it was much more profitable to give up 2 seashells of edge locally in order to import as many macarons as possible. This boosted profitability stemmed from the fact that even when giving up an extra seashell of edge (as compared with making for 1 seashell below mid), the extra fills more than made up for the edge we gave up when making. 

Our refined strategy therefore dynamically adjusted our quotes when we were market making in order to ensure we were capturing as much edge as possible. In instances where the shipping was greater than 2.77 (an amount that covered the spread cost locally and on the other island) we would market make locally in maximum size for 2 seashells below mid and once we had picked up a short position we imported the macarons from the other island. If shipping was less than 2.77 and greater than 1.77 we would market make for 1 seashell below mid locally before importing, and otherwise we wouldn’t trade. It was this understanding of the market participants and the market microstructure that was key to us developing a profitable strategy and managing to optimise our execution. 

## Other Market Observations

As well as being given data on the macarons on the local and other island, we were also given other market observations, namely sugar prices and a sunlight index. These values we were told could be used to try and find a directional signal in the price of the macarons. We were initially wary about looking for directional information encoded in this data as up until this point we had spent 3 rounds trying to find directional signals in other products to no avail. Pairing this with the high profitability of our locational arbitrage strategy, we initially invested little time into this lead. 

We did however notice that in instances where the sunlight index was low the prices of macarons seemed to rise. This observation was confirmed 24 hours before the deadline of Round 4, where a hint was released suggesting that there was a Critical Sunlight Index (CSI). The hint stated that if the sunlight index goes below this CSI with an anticipation to remain under this critical level for a long period of time, macaron prices can increase by a substantial amount. This could have presented an opportunity for large profit if it weren’t for the fact that holding a long position in macarons came with a cost associated. It cost 0.1 seashells per macaron per timestamp to hold a long position. Therefore, by simply observing the historical charts and marking the price movements of the macarons in instances where the sunlight index was low, we were able to get a rough idea of the profitability of implementing a strategy based on this information. We found that even if you were able to perfectly buy the minimum and sell the maximum, due to the holding costs there was very little edge in going long the macarons and it was far less profitable than the locational arbitrage. While there was a small amount of edge in this trade, this confirmed what we initially suspected, that this opportunity was a red herring, trying to throw people off the scent of the actual edgy trade. Putting on this trade also came with the opportunity cost of not being able to perform the locational arbitrage trade, as you couldn’t import macarons when you were long. 
